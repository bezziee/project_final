...
def hotels(request):
    return render(request, 'accounts/hotels.html')


def destination(request):
    return render(request, 'accounts/destinations/index.html')


def contact_us(request):
    context={}
    context['forms'] = ContactusForm()
    return render(request, 'accounts/contacts.html')


   #return render(request, 'accounts/contacts.html')
# def contact_success(request):
# return render(request, 'accounts/contactussuccess.html')
